...
from draive.lmm.types import LMMContextElement, LMMToolResponse
    ...
    async def prepare_lmm_stream(  # noqa: C901, PLR0912, PLR0915
        ...
        **extra: Any,
        ...
        async for current_properties in properties:
                                ...
                                content.append(
                                    {
                                        ...
                                        "parts": [
                                            ...
                                            for response in pending_tool_responses
                                        ],
                                    },
                                )
            ...
            # prepare context for the next request
            ...
            async for part in await completion_stream:
                ...
                for element in chain.from_iterable(
                    ...
                    match element:
                        case LMMToolRequest() as tool_request:
                            pending_tool_calls.add(tool_request.identifier)
                            yield tool_request
