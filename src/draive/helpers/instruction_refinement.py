...
You are an expert prompt enginner providing feedback and recemmondations for instruction improvement.
...
<approach>[Explaination of the approach with description of recommendations]</approach>
</strategy>
</format>
"""  # noqa: E501
    ...
    for strategy_element in MultimodalTagElement.parse("STRATEGY", content=response):
        ...
        approach_elem: MultimodalTagElement | None = MultimodalTagElement.parse_first(
            "APPROACH", content=strategy_element.content
        )
...
You are an expert prompt enginner refining provided instructions referred as a subject.
