...
@deprecated("`auto_retry` will be renamed to `retry`")
@overload
...
def auto_retry[**Args, Result](
    ...
    *,
    ...
    return retry(  # pyright: ignore[reportCallIssue, reportUnknownVariableType]
        function,
        limit=limit,
        delay=delay,
        catching=catching,
        ...
        **kwargs: Args.kwargs,
        ...
        while True:
            try:
                ...
                if attempt < limit and any(isinstance(exc, exception) for exception in catching):  # pyright: ignore[reportUnnecessaryIsInstance]
                    attempt += 1
                    ctx.log_warning(
