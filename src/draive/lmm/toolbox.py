            ...
            case Toolbox() as toolbox:
                match suggest:
                    case None:
                        return cls(
                            tools=toolbox.tools,
                            suggest_tool=toolbox.suggest_tool,
                            repeated_calls_limit=repeated_calls_limit
                            or toolbox.repeated_calls_limit,
                        )

                    case True:
                        return cls(
                            tools=toolbox.tools,
                            suggest_tool=toolbox.suggest_tool or True,
                            repeated_calls_limit=repeated_calls_limit
                            or toolbox.repeated_calls_limit,
                        )
                    ...
                    case tool:
                        return cls(
                            tools={**toolbox.tools, tool.name: tool},
                            suggest_tool=tool,
                            repeated_calls_limit=repeated_calls_limit
                            or toolbox.repeated_calls_limit,
                        )
